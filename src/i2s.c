...
volatile struct sdio_queue i2sBufDesc[2];
static uint8_t buffer_n=0;
...
void i2s_init(i2s_cb_t cb, int size)
{
    ...
    i2sBufDesc[1].owner = 1;
    i2sBufDesc[1].eof = 1;
    i2sBufDesc[1].sub_sof = 0;
    i2sBufDesc[1].datalen = size;
    i2sBufDesc[1].blocksize = size;
    i2sBufDesc[1].buf_ptr=(uint32_t)i2s_cb();
    i2sBufDesc[1].unused=0;
